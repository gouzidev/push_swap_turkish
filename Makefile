...
#    Updated: 2024/04/20 21:02:12 by sgouzi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parse.c sort.c split.c helper1.c helper2.c push_to_b.c linked_list1.c linked_list2.c operations1.c operations2.c push_to_a.c
